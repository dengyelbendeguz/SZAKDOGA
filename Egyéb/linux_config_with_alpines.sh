...
# Alpines
	echo "[+]Run alpine1 and connect to macvlan511"
	docker_run alpine1 alpine:latest

	docker_network_connect 192.168.1.3 macvlan_511 alpine1
	echo "[+]alpine1 has started. Everything is okay?"
	read Verify
	
	echo "[+]Run alpine3 and connect to macvlan533"
	docker_run alpine3 alpine:latest

	docker_network_connect 192.168.3.3 macvlan_533 alpine3
	echo "[+]alpine3 has started. Everything is okay?"
	read Verify
...
# Alpines
	echo "[+]Run alpine2 and connect to macvlan522"
	docker_run alpine2 alpine:latest

	docker_network_connect 192.168.2.3 macvlan_522 alpine2
	echo "[+]alpine2 has started. Everything is okay?"
	read Verify
	
	echo "[+]Run alpine4 and connect to macvlan544"
	docker_run alpine4 alpine:latest

	docker_network_connect 192.168.4.3 macvlan_544 alpine4
	echo "[+]alpine4 has started. Everything is okay?"
	read Verify
